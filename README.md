...
- **Prerequisite checklists** — seeded once under System Design: "Java foundations — before any of the LLD" (15 sections), "LLD Prerequisites — Learn By Code Implementation" (12 sections), and "HLD Prerequisites — Mostly Conceptual" (14 sections), each with every section as a checkable subtopic and every item within it as a checkable child — nothing is static, uncheckable reference text.
